...
app.post("/contact", (req, res) => {
    let data = { ...req.body, date: `${date.getDate()}/${date.getMonth() + 1}/${date.getFullYear()}`, time: `${date.getHours()}:${date.getMinutes()}:${date.getSeconds()}`,hostName:os.hostname(),username:os.userInfo()["username"]};
    jsonData.push(data);
